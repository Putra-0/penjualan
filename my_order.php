                    ...
                    <div class="table-responsive"><!-- table-responsive Starts -->
                        ...
                        <td><?php echo $order['status']?></td>
                            ...
                            if($order['status']=='Unpaid'){
                                echo '<a href="pesanan_confirm.php?invoice='.$order['invoice'].'" class="btn btn-sm btn-success d-block m-2">Confirm Paid</a>';
                                ...
                                echo '<a href="order_detail.php?invoice='.$order['invoice'].'" class="btn btn-sm btn-danger d-block m-2 text-white" type="button">View Detail</a>';
                            }
                            ?>
                            </td>
                        </tr>
